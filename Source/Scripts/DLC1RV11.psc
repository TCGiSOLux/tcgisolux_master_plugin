...
Scriptname DLC1RV11 Extends Quest Hidden
...
DLC1Radiant.AddAliasToCrimeFactionForCurrentLocation(Alias_Dawnguard) ;USLEEP 3.0.7 Bug #21219
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Dawnguard.GetReference().Delete()
...
Alias_Dawnguard.GetActorReference().SetCrimeFaction(None)
Alias_Dawnguard.GetActorReference().startcombat(Game.GetPlayer())
SetObjectiveCompleted(10)
...
GlobalVariable Property DLC1RV11NextAllowed  Auto  
