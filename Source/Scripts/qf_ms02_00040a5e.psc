...
SilverOre.Enable()
Alias_Thonar.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 1)
MS02FIN.Start()

;Enable player bed
Alias_PlayerBed.GetRef().enable()
;kill all the Cidhna Mine prisoners
Alias_Braig.GetActorReference().Kill()
Alias_Grisvar.GetActorReference().Kill()

;Begin USLEEP 3.0.7 Bug #21254
Actor Uraccen = Alias_Uraccen.GetActorReference()
Alias_Uraccen.Clear()
Actor Duach = Alias_Duach.GetActorReference()
Alias_Duach.Clear()
Actor Odvan = Alias_Odvan.GetActorReference()
Alias_Odvan.Clear()
Actor Borkul = Alias_Borkul.GetActorReference()
Alias_Borkul.Clear()
...
If (Alias_Grisvar.GetActorReference().IsDead() == 1)
  SetStage(60)
EndIf

;Remove Grisvar from the Crime Faction
Alias_Grisvar.GetActorReference().RemoveFromFaction(CrimeFactionCidhnaMine)
Alias_Grisvar.GetActorReference().RemoveFromFaction(TownCidhnaMinePrisonerFaction)
Alias_Grisvar.GetActorReference().SetCrimeFaction(None)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_MadanachDoor.GetReference().Lock(False)
...
;Tunnel is open
Alias_EscapeTunnelDoor.GetReference().Lock(False)
Alias_DoortoTunnel.GetReference().Lock(False)

;Everyone runs to the tunnel
Alias_Borkul.GetActorReference().EvaluatePackage()
Alias_Odvan.GetActorReference().EvaluatePackage()
Alias_Uraccen.GetActorReference().EvaluatePackage()
Alias_Duach.GetActorReference().EvaluatePackage()
Alias_Braig.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Madanach.GetActorReference().AddItem(MS02MadanachKey, 1)
...
SilverOre.Enable()
;Enable player bed
Alias_PlayerBed.GetReference().enable()
MS02FIN.Start()
Stop()
;END CODE
EndFunction
...
Alias_Madanach.GetActorReference().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
;Grisvar flees
Alias_Grisvar.GetActorReference().AddtoFaction(MS02GrisvarEnemyFaction)
Alias_Grisvar.GetActorReference().SetAv("Aggression", 2)
;END CODE
EndFunction
;END FRAGMENT
