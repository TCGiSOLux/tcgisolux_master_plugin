scriptname TCGQuestSetVarBYOHC extends ObjectReference  
    ...
    Event onTriggerEnter(ObjectReference triggerRef)
        ...
        If (triggerRef == (PlayerREF as ObjectReference))
            If TCGGlobalVariable.GetValueInt() == 0
                If ORFlag == True
                    If NPCREF.IsDead() == true && NPCREF2.IsDead() == true && BYOHDisallowAdoption.GetValue()== 0 || NPCREF.IsDead() == true && NPCREF2.IsDead() == true && NPCREF3.IsDead() == true && BYOHDisallowAdoption.GetValue()== 1
                    ...
                    Endif
                Else
                    If NPCREF.IsDead() == true && NPCREF2.IsDead() == true && BYOHDisallowAdoption.GetValue()== 1
                     TCGGlobalVariable.SetValueInt(currentgamedays)
                        If ControlStage != 0
                            ControlQuest.SetStage(ControlStage)
                        EndIf
