scriptname TCGQuestSetVarBYOHD extends ObjectReference  
    ...
    Event onTriggerEnter(ObjectReference triggerRef)
        ...
        If (triggerRef == (PlayerREF as ObjectReference))
            If TCGGlobalVariable.GetValueInt() == 0
                If ORFlag == True
                    If NPCREF.IsDead() == true && BYOHDisallowAdoption.GetValue()== 0 || NPCREF.IsDead() == true && NPCREF2.IsDead() == true && NPCREF3.IsDead() == true && BYOHDisallowAdoption.GetValue()== 1
