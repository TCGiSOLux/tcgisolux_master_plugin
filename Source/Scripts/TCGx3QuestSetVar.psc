scriptname TCGx3QuestSetVar extends ObjectReference  
    ...
    Event onTriggerEnter(ObjectReference triggerRef)
        ...
        If (triggerRef == (PlayerREF as ObjectReference))
            If TCGGlobalVariable.GetValueInt() == 0
                If currentstageA > TriggerQuestAStage && currentstageB > TriggerQuestBStage && currentstageC > TriggerQuestCStage
