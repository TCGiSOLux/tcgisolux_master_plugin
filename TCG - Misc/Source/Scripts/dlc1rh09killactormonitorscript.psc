Scriptname DLC1RH09KillActorMonitorScript extends Quest  
{Script attached to DLC1RH09KillActorMonitor Quest}

DLC1RadiantScript Property DLC1Radiant auto
Quest Property TCGDLC1RH09 auto
ReferenceAlias Property DLC1RH09Victim auto

keyword Property DLC1RH09VampireGarb auto
...
Event OnStoryKillActor(ObjectReference akVictim, ObjectReference akKiller, Location akLocation, int aiCrimeStatus, int aiRelationshipRank)
	...
	if DLC1Radiant.IsHighProfileTargetB(akVictim)
	...
	if (Game.GetPlayer().WornHasKeyword(DLC1RH09VampireGarb) == False)	
		;Debug.Trace(self + "is NOT wearing vampire armor")
		CrimeReportedAndDisguised = 0
	endif
	...
	DLC1RH09Victim.ForceRefTo(akVictim)
	TCGDLC1RH09.SetStage(100 + CrimeReportedAndDisguised + HighProfileTarget)
	Stop()
