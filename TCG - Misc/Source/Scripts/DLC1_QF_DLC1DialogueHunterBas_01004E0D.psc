...
Alias_AgmaerAliasBackup.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 2)
Alias_BelevalAliasBackup.GetActorReference().SetRelationshipRank(Game.GetPlayer(), 2)
Alias_IngjardAliasBackup.GetActorReference().SetRelationshipRank(Game.Getplayer(), 2)
Alias_DurakAliasBackup.GetActorReference().SetRelationshipRank(Game.Getplayer(), 2)
Alias_CelannAliasBackup.GetActorReference().SetRelationshipRank(Game.Getplayer(), 2)
pThaneCount.Value += 1
pFFRTQS.ThaneCheck()
;END CODE
EndFunction
