...
;Set Vigilant of Stendarr faction to Dawnguard Hunter Faction neutral if player worns any Daedric Artifact
VigilantOfStendarrFaction.SetEnemy(DLC1HunterFaction, true, true)
