...
if DLC2MQ01.GetStage() >= 5
    Alias_Actor1.GetActorReference().RemoveFromFaction(dunPrisonerFaction)
    Alias_Actor2.GetActorReference().RemoveFromFaction(dunPrisonerFaction)
    Alias_Actor3.GetActorReference().RemoveFromFaction(dunPrisonerFaction)
    Alias_Actor1.GetActorReference().RemoveFromFaction(WEPlayerFriend)
    Alias_Actor2.GetActorReference().RemoveFromFaction(WEPlayerFriend)
    Alias_Actor3.GetActorReference().RemoveFromFaction(WEPlayerFriend)
