...
Alias_PlayerFriend.ForceRefTo(Alias_Ralof.GetRef())
; enable NPCs we need
...
Alias_KeepLockedDoor1.GetRef().Lock(false)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Ralof.GetActorRef().RemoveItem(PrisonerCuffs)
Alias_BarracksRoomSoldier01.TrytoEnable()
Alias_BarracksRoomSoldier02.TrytoEnable()
...
Scene1.Stop()
;Scene2.Stop() ;USSEP 4.3.1 Bug #33789
Scene3.Stop()
utility.wait(1)
setstage(180)
setstage(190)
setstage(195)
;setstage(220)
Game.GetPlayer().moveto(PlayerSonKeepMarker1)
...
Alias_ImperialSoldierFort01.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
;Alias_Headsman.GetActorRef().PlayIdle(IdleExecutionerAlduinReactionDeath)
...
;BEGIN CODE
; cart 2 stops
Alias_Cart2.GetRef().SetMotionType(Alias_Cart1.GetRef().Motion_Keyframed)
; stop cart sounds
...
Alias_BarracksRoomSoldier01.GetActorRef().StartCombat(Game.GetPlayer())
Alias_BarracksRoomSoldier02.GetActorRef().StartCombat(Game.GetPlayer())

;disable Levers
Alias_KeepLever1.GetRef().BlockActivation()
Alias_KeepLever2.GetRef().BlockActivation()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Ulfric.GetActorRef().PlayIdle(OffSetStop)
Alias_Ulfric.GetActorRef().RemoveItem(PrisonerCuffs, 1)
Alias_Ralof.GetActorRef().SetOutfit(RalofOutfit)
Alias_Ralof.GetActorRef().PlayIdle(OffSetStop)
Alias_StormcloakPrisoner01.GetActorRef().RemoveItem(PrisonerCuffs)
Alias_StormcloakPrisoner02.GetActorRef().RemoveItem(PrisonerCuffs)
Alias_StormcloakPrisoner03.GetActorRef().RemoveItem(PrisonerCuffs)
Alias_Ulfric.GetActorRef().UnEquipItem(ArmorGag)
...
Alias_KeepLever1.GetRef().Activate(Alias_BarracksRoomSoldier02.GetRef())
; debug.trace("opening keep gate...")
(KeepGate1 as default2stateactivator).SetOpen()
; debug.trace("opening keep gate... DONE")
...
kmyquest.RegisterForAnimationEvent(Alias_StormcloakPrisoner01.GetActorRef(), "Decapitate")
;END CODE
EndFunction
;END FRAGMENT
...
;Game.GetPlayer().moveto(PlayerMarker8)
...
; for quickstarting
;Alias_Prisoner01.GetActorRef().Kill()
...
;END AUTOCAST
;BEGIN CODE
; debug.trace("stage 15")
; start everything moving
Alias_GeneralTullius.GetActorRef().EvaluatePackage()
Alias_CartHorse1.GetActorRef().EvaluatePackage()
Alias_CartHorse2.GetActorRef().EvaluatePackage()
Alias_Hadvar.GetActorRef().EvaluatePackage()
;TempMessage1.Show()
...
;WJS - commenting out sways to see if tht helps Emulation
;start sways
; cart 2 animations
;Alias_ImperialSoldier01.GetActorRef().PlayIdle(IdleCartDriverSway)
;Alias_Ralof.GetActorRef().PlayIdle(IdleCartPrisonerDSway)
;Alias_Prisoner01.GetActorRef().PlayIdle(IdleCartPrisonerBSway)
;Alias_Ulfric.GetActorRef().PlayIdle(IdleCartPrisonerASway)
;Game.GetPlayer().PlayIdle(IdleCartPrisonerCSway)

; cart 1 animations
;Alias_ImperialSoldier02.GetActorRef().PlayIdle(IdleCartDriverSway)
;Alias_StormcloakPrisoner02.GetActorRef().PlayIdle(IdleCartPrisonerBSway)
;Alias_StormcloakPrisoner03.GetActorRef().PlayIdle(IdleCartPrisonerDSway)
;Alias_StormcloakPrisoner04.GetActorRef().PlayIdle(IdleCartPrisonerASway)
;Alias_StormcloakPrisoner01.GetActorRef().PlayIdle(IdleCartPrisonerCSway)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Torturer.GetActorRef().GetActorBase().SetProtected()
SetStage(365)
;END CODE
EndFunction
;END FRAGMENT
...
; stop sways
; cart 2 animations
Alias_ImperialSoldier01.GetActorRef().PlayIdle(kmyQuest.IdleCartDriverIdle)
Alias_Ralof.GetActorRef().PlayIdle(kmyQuest.IdleCartPassengerDIdle)
Alias_Prisoner01.GetActorRef().PlayIdle(kmyQuest.IdleCartPassengerBIdle)
Alias_Ulfric.GetActorRef().PlayIdle(kmyQuest.IdleCartPassengerAIdle)
Game.GetPlayer().PlayIdle(kmyQuest.IdleCartPassengerCIdle)

; cart 1 animations
Alias_ImperialSoldier02.GetActorRef().PlayIdle(kmyQuest.IdleCartDriverIdle)
Alias_StormcloakPrisoner02.GetActorRef().PlayIdle(kmyQuest.IdleCartPassengerBIdle)
Alias_StormcloakPrisoner03.GetActorRef().PlayIdle(kmyQuest.IdleCartPassengerDIdle)
Alias_StormcloakPrisoner04.GetActorRef().PlayIdle(kmyQuest.IdleCartPassengerAIdle)
Alias_StormcloakPrisoner01.GetActorRef().PlayIdle(kmyQuest.IdleCartPassengerCIdle)
;END CODE
EndFunction
;END FRAGMENT
...
Alias_PlayerFriend.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Hadvar.GetActorRef().IgnoreFriendlyHits()
Alias_Ralof.GetActorRef().IgnoreFriendlyHits()
Alias_Hadvar.GetActorRef().SetNotShowOnStealthMeter(true)
Alias_Ralof.GetActorRef().SetNotShowOnStealthMeter(true)
Alias_Hadvar.GetActorRef().BlockActivation()
Alias_Ralof.GetActorRef().BlockActivation()
;END CODE
EndFunction
;END FRAGMENT
...
setstage(195)
;setstage(210)
Game.GetPlayer().moveto(PlayerImperialKeepMarker1)
...
Actor myImperialSoldier01 = Alias_ImperialSoldier01.GetActorRef()
Actor myRalof = Alias_Ralof.GetActorRef()
actor myPrisoner01 = Alias_Prisoner01.GetActorRef()
Actor myUlfric = Alias_Ulfric.GetActorRef()
Actor myPlayer = Game.GetPlayer()
ObjectReference myCart2 = Alias_Cart2.GetRef()

Actor myImperialSoldier02 = Alias_ImperialSoldier02.GetActorRef()
Actor myStormcloakPrisoner01 = Alias_StormcloakPrisoner01.GetActorRef()
Actor myStormcloakPrisoner02 = Alias_StormcloakPrisoner02.GetActorRef()
Actor myStormcloakPrisoner03 = Alias_StormcloakPrisoner03.GetActorRef()
Actor myStormcloakPrisoner04 = Alias_StormcloakPrisoner04.GetActorRef()
ObjectReference myCart1 = Alias_Cart1.GetRef()
...
Alias_Torturer.GetActorRef().ResetHealthAndLimbs()
;END CODE
EndFunction
;END FRAGMENT
...
kmyquest.RegisterForAnimationEvent(Alias_Alduin.GetActorRef(), "FlightLanding")
kmyquest.RegisterForAnimationEvent(Alias_Alduin.GetActorRef(), "TowerLandImpact")
...
; make unaggressive 
Alias_HallwayStormcloak01.GetActorRef().SetActorValue("Aggression", 0)
Alias_HallwayStormcloak02.GetActorRef().SetActorValue("Aggression", 0)
Alias_HallwayStormcloak03.GetActorRef().SetActorValue("Aggression", 0)
;END CODE
EndFunction
;END FRAGMENT
...
;make aggressive
Alias_TortureRoomImperialSoldier1.GetActorRef().SetActorValue("Aggression", 1)
Alias_TortureRoomImperialSoldier2.GetActorRef().SetActorValue("Aggression", 1)
Alias_TortureRoomImperialSoldier3.GetActorRef().SetActorValue("Aggression", 1)
Alias_Torturer.GetActorRef().SetActorValue("Aggression", 1)
Alias_TortureRoomStormcloak1.GetActorRef().SetActorValue("Aggression", 1)
Alias_TortureRoomStormcloak2.GetActorRef().SetActorValue("Aggression", 1)
Alias_TortureRoomStormcloak3.GetActorRef().SetActorValue("Aggression", 1)

; start combat
Alias_TortureRoomStormcloak1.GetActorRef().StartCombat(Alias_Torturer.GetActorRef())
Alias_TortureRoomStormcloak2.GetActorRef().StartCombat(Alias_TortureRoomImperialSoldier1.GetActorRef())
Alias_Torturer.GetActorRef().StartCombat(Alias_TortureRoomStormcloak1.GetActorRef())
Alias_TortureRoomImperialSoldier1.GetActorRef().StartCombat(Alias_TortureRoomStormcloak2.GetActorRef())
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
; cart 1 stops
Alias_Cart1.GetRef().SetMotionType(Alias_Cart1.GetRef().Motion_Keyframed)
...
Alias_KeepDoorInteriorImperials.GetRef().BlockActivation(false)
Alias_KeepDoorInteriorStormcloaks.GetRef().BlockActivation(false)
...
;END AUTOCAST
;BEGIN CODE
; debug.trace(self + "stage 10, quickstart 0")
;disable first person geometry
Game.ShowFirstPersonGeometry( false )
; disable save
...
Game.GetPlayer().moveto(Alias_PlayerStartMarker.GetRef())
; set weather
SkyrimClear.ForceActive(true) ; weather override
...
IntroMusic.Add()
; play cart sounds
kmyquest.CartSoundInstanceID = CartSound.Play(Game.GetPlayer())
; open gates -- not opening the east gate for now
;EastGate.SetOpen(true)
...
Alias_TrophyRoomPrisoner02.GetActorRef().StartCombat(Game.GetPlayer())
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Ulfric.GetActorRef().SetHeadTracking()
Alias_Ralof.GetActorRef().SetHeadTracking()
Alias_Ulfric.GetActorRef().SetHeadTracking()

Alias_StormcloakPrisoner01.GetActorRef().SetHeadTracking()
Alias_StormcloakPrisoner02.GetActorRef().SetHeadTracking()
Alias_StormcloakPrisoner03.GetActorRef().SetHeadTracking()
Alias_StormcloakPrisoner04.GetActorRef().SetHeadTracking()
;END CODE
EndFunction
;END FRAGMENT
...
Alias_Bear.GetActorRef().EvaluatePackage()
;END CODE
EndFunction
;END FRAGMENT
