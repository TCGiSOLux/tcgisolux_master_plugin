...
elseif (akSpeakerRef == CamillaLeotelli.GetRef())
	LailatheUnbroken.GetActorRef().EvaluatePackage()
elseif (akSpeakerRef == LailatheUnbroken.GetRef())
	CamillaLeotelli.GetActorRef().EvaluatePackage()
endif
;END CODE
EndFunction
;END FRAGMENT
...
ReferenceAlias Property CamillaLeotelli  Auto
ReferenceAlias Property LailatheUnbroken  Auto
