...
if (Game.GetPlayer().GetItemCount(SuvarisJournal.GetRef()) == 0)
	WindhelmClanShatterShieldOffice.SetPublic(true)
	WindhelmEastEmpireCompany.SetPublic(true)
...
Function Fragment_4()
;BEGIN CODE
WindhelmClanShatterShieldOffice.SetPublic(false)
...
; Remove Pirates in Dawnstar - Block added by USKP 1.3.1
Alias_Stig.GetReference().Disable()
Alias_Pirate1.GetReference().Disable()
Alias_Pirate2.GetReference().Disable()
Alias_Pirate3.GetReference().Disable()
;END CODE
EndFunction
;END FRAGMENT
...
MS10PostQuest.Start()
WindhelmEastEmpireCompany.SetPublic(false)
...
Cell Property WindhelmEastEmpireCompany Auto
Cell Property WindhelmClanShatterShieldOffice Auto