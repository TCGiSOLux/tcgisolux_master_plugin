...
;BEGIN ALIAS PROPERTY GhoragdushAllias
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_GhoragdushAllias Auto
;END ALIAS PROPERTY

;BEGIN ALIAS PROPERTY AssumanuAllias
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_AssumanuAllias Auto
;END ALIAS PROPERTY

;BEGIN ALIAS PROPERTY AlusannahAllias
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_AlusannahAllias Auto
;END ALIAS PROPERTY
...
Alias_HarkonBattleMeleeForm.TryToAddToFaction(DLC1dunHarkonBattleAllyFaction)
;Alias_HarkonBattleMeleeForm.GetActorRef().GetActorBase().SetEssential(False)
Alias_HarkonBattleMeleeForm.GetActorReference().SetAv("Aggression",1)
Alias_HarkonBattleMeleeForm.GetActorReference().StartCombat(Game.GetPlayer())

Alias_HarkonBattleMagicForm.TryToAddToFaction(DLC1dunHarkonBattleAllyFaction)
;Alias_HarkonBattleMagicForm.GetActorRef().GetActorBase().SetEssential(False)
Alias_HarkonBattleMagicForm.GetActorReference().SetAv("Aggression",1)
Alias_HarkonBattleMagicForm.GetActorReference().StartCombat(Game.GetPlayer())

if pDLC1PlayingVampireLine.GetValue() == 0

	;Prevent vampires to replacing members
	...
	Alias_LalaineCatiaAlias.GetActorReference().Kill(game.getPlayer()) ; Added by TCGiSOLux Master Plugin Interior
	Alias_CaraorilAlias.GetActorReference().Kill(game.getPlayer()) ; Added by TCGiSOLux Master Plugin Interior
	Alias_JulisandeAlias.GetActorReference().Kill(game.getPlayer()) ; Added by TCGiSOLux Master Plugin Interior
	Alias_UlenraneAlias.GetActorReference().Kill(game.getPlayer()) ; Added by TCGiSOLux Master Plugin Interior
	Alias_HertAlias.GetActorReference().Kill(game.getPlayer()) ; Added by TCGiSOLux Master Plugin Interior
	Alias_AlusannahAllias.GetActorReference().Kill(game.getPlayer()) ; Added by TCGiSOLux Master Plugin Interior
	Alias_GhoragdushAllias.GetActorReference().Kill(game.getPlayer()) ; Added by TCGiSOLux Master Plugin Interior
	Alias_AssumanuAllias.GetActorReference().Kill(game.getPlayer()) ; Added by TCGiSOLux Master Plugin Interior
	...
	alias_DLC1VQ08RNPCAlias.TryToRemoveFromFaction(DLC1VQ08HunterSiegeFaction)
	alias_DLC1VQ08IsranAlias.TryToRemoveFromFaction(DLC1VQ08HunterSiegeFaction)
	alias_DLC1VQ08CelannAlias.TryToRemoveFromFaction(DLC1VQ08HunterSiegeFaction)
	alias_DLC1VQ08DurakAlias.TryToRemoveFromFaction(DLC1VQ08HunterSiegeFaction)
	alias_DLC1VQ08FlorentiusAlias.TryToRemoveFromFaction(DLC1VQ08HunterSiegeFaction)
	alias_DLC1VQ08GunmarAlias.TryToRemoveFromFaction(DLC1VQ08HunterSiegeFaction)
...
Alias_HarkonBattleRealHarkon.TryToDisable() ;Disable the 'real' Harkon.
Alias_DLC1VQ08HarkonAlias.ForceRefTo(Alias_HarkonBattleMagicForm.GetActorReference()) ;Harkon starts in magic form.
Alias_DLC1VQ08HarkonAlias.TryToEnable()
Alias_DLC1VQ08HarkonAlias.TryToMoveTo(DLC1VQ08HarkonStartMarker)
(Alias_HarkonBattleMagicForm.GetActorReference() as DLC1HarkonCombatMagicLevelingScript).InitializeHarkon()
(Alias_HarkonBattleMeleeForm.GetActorReference() as DLC1HarkonCombatMeleeLevelingScript).InitializeHarkon()
...
if pDLC1PlayingVampireLine.GetValue() == 0
	...
	Alias_AlusannahAllias.GetActorReference().GetActorBase().SetEssential(False) ; Added by TCGiSOLux Master Plugin Interior
	Alias_GhoragdushAllias.GetActorReference().GetActorBase().SetEssential(False) ; Added by TCGiSOLux Master Plugin Interior
	Alias_AssumanuAllias.GetActorReference().GetActorBase().SetEssential(False) ; Added by TCGiSOLux Master Plugin Interior
