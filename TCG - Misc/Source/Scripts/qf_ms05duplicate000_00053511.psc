...
Function Fragment_6()
;BEGIN CODE
alias_MS05Viarmo.TryToEvaluatePackage()
...
MS05Start.setObjectiveCompleted(10) ;Added by USKP 1.3.3
MS05Start.Stop() ;Added by USKP 1.3.3
;END CODE
EndFunction
;END FRAGMENT
...
;USKP 2.1.3 Bug #19392
if (Game.IsPluginInstalled("unofficial skyrim special edition patch.esp"))
Spell USLEEPMS05Reward = Game.GetFormFromFile( 0x000028C8, "unofficial skyrim special edition patch.esp" ) as Spell
Spell USLEEPMS05RewardNoDisplay = Game.GetFormFromFile( 0x000028C9, "unofficial skyrim special edition patch.esp" ) as Spell
...
Alias_MS05Viarmo.GetActorReference().MakePlayerFriend()
Alias_MS05Jorn.GetActorReference().MakePlayerFriend()
Alias_MS05Giraud.GetActorReference().MakePlayerFriend()
...
MS05Start.Stop() ;Added by USKP 1.2.4
;setObjectiveCompleted(50) - USKP 2.0.1: There is no objective 50.
setObjectiveDisplayed (75)
Alias_MS05DeadMansRespiteMapmarker.GetReference().AddToMap()
;END CODE
EndFunction
;END FRAGMENT
