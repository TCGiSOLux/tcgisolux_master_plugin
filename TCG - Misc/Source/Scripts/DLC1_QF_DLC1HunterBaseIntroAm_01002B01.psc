...
Function Setup()
	if (Game.IsPluginInstalled("TCGiSOLux.esm"))
	ActorBase LvlVCV = Game.GetFormFromFile(0x000000B0, "TCGiSOLux.esm") as ActorBase
	ActorBase LvlVCVB = Game.GetFormFromFile(0x00001B27, "TCGiSOLux.esm") as ActorBase
	ObjectReference Vampire1 = DLC1HunterBaseIntroAmbushMarker1.PlaceAtMe(LvlVCV,1)
	ObjectReference Vampire2 = DLC1HunterBaseIntroAmbushMarker2.PlaceAtMe(LvlVCV,1)
	ObjectReference Vampire3 = DLC1HunterBaseIntroAmbushMarker3.PlaceAtMe(LvlVCVB,1)
	AmbushCreature1.ForceRefTo(Vampire1)
	AmbushCreature2.ForceRefTo(Vampire2)
	AmbushCreature3.ForceRefTo(Vampire3)
	AmbushCreature1.GetActorReference().SetAV( "aggression", 2 )
	AmbushCreature2.GetActorReference().SetAV( "aggression", 2 )
	AmbushCreature3.GetActorReference().SetAV( "aggression", 2 )
	else
