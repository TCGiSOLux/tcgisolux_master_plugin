...
Faction Property DLC1RadiantHumterBanditNecroAllys auto
...
Formlist Property USLEEPDLC1RV03InitialHighProfileTargets Auto ; UDGP 2.0.3 for Bug #14812
...
bool Function IsActorInFactionInFormlist(Actor ActorToCheck, Formlist FormlistToCheck)
	...
	if( USLEEPDLC1RV03InitialHighProfileTargets.HasForm(BActor) )
		return True
	EndIf
...
bool Function IsHighProfileTargetA(ObjectReference akVictim)
...
;for use with DLC1RH09KillActorMonitorScript
bool Function IsHighProfileTargetB(ObjectReference akVictim)
	Actor Victim = akVictim as Actor
