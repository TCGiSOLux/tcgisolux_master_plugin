...
Scriptname FMCPatch_DLC1RV06 Extends Quest Hidden
...
if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionHaafingar) == 1
   Alias_Spouse.GetActorReference().RemoveFromFaction(CrimeFactionHaafingar)
endif

if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionReach) == 1
   Alias_Spouse.GetActorReference().RemoveFromFaction(CrimeFactionReach)
endif

if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionHjaalmarch) == 1
   Alias_Spouse.GetActorReference().RemoveFromFaction(CrimeFactionHjaalmarch)
endif

if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionWhiterun) == 1
   Alias_Spouse.GetActorReference().RemoveFromFaction(CrimeFactionWhiterun)
endif

if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionFalkreath) == 1
   Alias_Spouse.GetActorReference().RemoveFromFaction(CrimeFactionFalkreath)
endif

if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionPale) == 1
   Alias_Spouse.GetActorReference().RemoveFromFaction(CrimeFactionPale)
endif

if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionWinterhold) == 1
   Alias_Spouse.GetActorReference().RemoveFromFaction(CrimeFactionWinterhold)
endif

if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionEastmarch) == 1
   Alias_Spouse.GetActorReference().RemoveFromFaction(CrimeFactionEastmarch)
endif

if Alias_Spouse.GetActorReference().IsInFaction(CrimeFactionRift) == 1
